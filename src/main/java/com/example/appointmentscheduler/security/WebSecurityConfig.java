...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .antMatchers("/doctors/new").hasRole("ADMIN")
                .antMatchers("/invoices/all").hasRole("ADMIN")
                .antMatchers("/doctors/all").hasRole("ADMIN")
                .antMatchers("/customers/**").hasAnyRole("CUSTOMER", "ADMIN")
                .antMatchers("/doctors/availability/**").hasRole("PROVIDER")
                .antMatchers("/doctors/**").hasAnyRole("PROVIDER", "ADMIN")
